...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '04-cluster-deployment/phase-02-os-installation/task-01-delete-and-recreate-virtual-disk-on-dell-boss-card' `
    -ActionName 'Invoke-ResetBossVirtualDisk-Orchestrated' `
