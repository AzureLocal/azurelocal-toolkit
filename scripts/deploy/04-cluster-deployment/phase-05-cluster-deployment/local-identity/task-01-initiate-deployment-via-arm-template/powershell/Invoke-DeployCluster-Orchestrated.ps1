...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '04-cluster-deployment/phase-05-cluster-deployment/local-identity/task-01-initiate-deployment-via-arm-template' `
    -ActionName 'Invoke-DeployCluster-Orchestrated' `
