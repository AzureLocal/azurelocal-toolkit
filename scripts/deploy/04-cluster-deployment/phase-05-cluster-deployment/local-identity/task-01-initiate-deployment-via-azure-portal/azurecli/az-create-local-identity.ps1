...
Invoke-DeploymentAzCliPowerShell `
    ...
    -TaskPath '04-cluster-deployment/phase-05-cluster-deployment/local-identity/task-01-initiate-deployment-via-azure-portal' `
    -ActionName 'az-create-local-identity' `
