...
invoke_bash_deployment "$0" '04-cluster-deployment/phase-05-cluster-deployment/local-identity/task-01-initiate-deployment-via-azure-portal' 'az-create-local-identity' "$@"
