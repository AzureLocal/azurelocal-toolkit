...
invoke_bash_deployment "$0" '04-cluster-deployment/phase-05-cluster-deployment/local-identity/task-02-verify-deployment-completion' 'az-verify-local-identity' "$@"
