...
Invoke-DeploymentAzCliPowerShell `
    ...
    -TaskPath '04-cluster-deployment/phase-05-cluster-deployment/active-directory/task-01-initiate-deployment-via-arm-template' `
    -ActionName 'az-deploy-cluster-ad' `
