...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '04-cluster-deployment/phase-01-hardware-provisioning/task-02-hardware-discovery-via-dell-redfish-api' `
    -ActionName 'Invoke-HardwareDiscovery-Orchestrated' `
