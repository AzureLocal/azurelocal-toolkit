...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '04-cluster-deployment/phase-01-hardware-provisioning/task-04-bios-and-idrac-settings-validation' `
    -ActionName 'Invoke-BiosIdracValidation-Orchestrated' `
