...
invoke_bash_deployment "$0" '04-cluster-deployment/phase-01-hardware-provisioning/task-01-create-dhcp-reservations-for-idrac-interfaces' 'az-create-dhcp-reservations-idrac' "$@"
