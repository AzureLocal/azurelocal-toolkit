...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '04-cluster-deployment/phase-01-hardware-provisioning/task-01-create-dhcp-reservations-for-idrac-interfaces' `
    -ActionName 'Invoke-DhcpReservationsIdrac-Orchestrated' `
