...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '04-cluster-deployment/phase-01-hardware-provisioning/task-03-create-dhcp-reservations-for-management-nics' `
    -ActionName 'Invoke-DhcpReservationsMgmt-Orchestrated' `
