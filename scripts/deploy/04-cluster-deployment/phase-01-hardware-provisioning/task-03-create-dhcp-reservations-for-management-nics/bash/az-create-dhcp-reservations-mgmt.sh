...
invoke_bash_deployment "$0" '04-cluster-deployment/phase-01-hardware-provisioning/task-03-create-dhcp-reservations-for-management-nics' 'az-create-dhcp-reservations-mgmt' "$@"
