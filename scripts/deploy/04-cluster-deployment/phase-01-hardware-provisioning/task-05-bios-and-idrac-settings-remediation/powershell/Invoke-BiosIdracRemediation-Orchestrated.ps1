...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '04-cluster-deployment/phase-01-hardware-provisioning/task-05-bios-and-idrac-settings-remediation' `
    -ActionName 'Invoke-BiosIdracRemediation-Orchestrated' `
