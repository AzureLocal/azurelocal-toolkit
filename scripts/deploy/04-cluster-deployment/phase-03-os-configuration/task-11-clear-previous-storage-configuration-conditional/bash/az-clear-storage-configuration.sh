...
invoke_bash_deployment "$0" '04-cluster-deployment/phase-03-os-configuration/task-11-clear-previous-storage-configuration-conditional' 'az-clear-storage-configuration' "$@"
