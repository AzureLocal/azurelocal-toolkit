...
Invoke-DeploymentAzCliPowerShell `
    ...
    -TaskPath '04-cluster-deployment/phase-03-os-configuration/task-11-clear-previous-storage-configuration-conditional' `
    -ActionName 'az-clear-storage-configuration' `
