...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '02-azure-foundation/phase-01-landing-zones/simplified-deployment/task-01-configure-management-group' `
    -ActionName 'Invoke-ManagementGroup-Orchestrated' `
