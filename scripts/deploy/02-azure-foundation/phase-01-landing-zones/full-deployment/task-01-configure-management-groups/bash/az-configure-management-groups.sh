...
invoke_bash_deployment "$0" '02-azure-foundation/phase-01-landing-zones/full-deployment/task-01-configure-management-groups' 'az-configure-management-groups' "$@"
