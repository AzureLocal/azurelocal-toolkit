...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '02-azure-foundation/phase-01-landing-zones/full-deployment/task-01-configure-management-groups' `
    -ActionName 'Invoke-ManagementGroups-Orchestrated' `
