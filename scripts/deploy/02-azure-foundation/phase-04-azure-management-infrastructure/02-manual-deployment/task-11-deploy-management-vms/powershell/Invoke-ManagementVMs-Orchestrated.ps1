...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '02-azure-foundation/phase-04-azure-management-infrastructure/02-manual-deployment/task-11-deploy-management-vms' `
    -ActionName 'Invoke-ManagementVMs-Orchestrated' `
