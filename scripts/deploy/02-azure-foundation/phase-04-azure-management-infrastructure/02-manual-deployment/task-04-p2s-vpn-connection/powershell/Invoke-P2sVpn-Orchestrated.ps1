...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '02-azure-foundation/phase-04-azure-management-infrastructure/02-manual-deployment/task-04-p2s-vpn-connection' `
    -ActionName 'Invoke-P2sVpn-Orchestrated' `
