...
invoke_bash_deployment "$0" '02-azure-foundation/phase-04-azure-management-infrastructure/02-manual-deployment/task-04-p2s-vpn-connection' 'az-configure-p2s-vpn' "$@"
