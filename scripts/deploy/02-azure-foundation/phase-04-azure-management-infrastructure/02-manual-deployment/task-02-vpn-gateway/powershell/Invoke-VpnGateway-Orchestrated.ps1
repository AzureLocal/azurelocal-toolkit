...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '02-azure-foundation/phase-04-azure-management-infrastructure/02-manual-deployment/task-02-vpn-gateway' `
    -ActionName 'Invoke-VpnGateway-Orchestrated' `
