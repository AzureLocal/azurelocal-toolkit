...
invoke_bash_deployment "$0" '02-azure-foundation/phase-04-azure-management-infrastructure/02-manual-deployment/task-06-network-security-groups' 'az-deploy-lighthouse-nsg' "$@"
