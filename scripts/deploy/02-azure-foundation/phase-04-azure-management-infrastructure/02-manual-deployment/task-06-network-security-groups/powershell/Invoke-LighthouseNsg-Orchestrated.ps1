...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '02-azure-foundation/phase-04-azure-management-infrastructure/02-manual-deployment/task-06-network-security-groups' `
    -ActionName 'Invoke-LighthouseNsg-Orchestrated' `
