...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '02-azure-foundation/phase-04-azure-management-infrastructure/01-cicd-pipeline-deployment/phase-03-validation/task-02-test-connectivity' `
    -ActionName 'Invoke-TestConnectivity-Orchestrated' `
