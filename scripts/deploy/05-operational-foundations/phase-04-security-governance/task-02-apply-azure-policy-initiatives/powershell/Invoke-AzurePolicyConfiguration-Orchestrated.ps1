...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '05-operational-foundations/phase-04-security-governance/task-02-apply-azure-policy-initiatives' `
    -ActionName 'Invoke-AzurePolicyConfiguration-Orchestrated' `
