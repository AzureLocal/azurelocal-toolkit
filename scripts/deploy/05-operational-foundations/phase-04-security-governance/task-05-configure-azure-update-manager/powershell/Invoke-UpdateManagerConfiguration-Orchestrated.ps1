...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '05-operational-foundations/phase-04-security-governance/task-05-configure-azure-update-manager' `
    -ActionName 'Invoke-UpdateManagerConfiguration-Orchestrated' `
