...
invoke_bash_deployment "$0" '05-operational-foundations/phase-05-licensing-telemetry/task-02-activate-windows-server-subscription' 'az-enable-windows-server-subscription' "$@"
