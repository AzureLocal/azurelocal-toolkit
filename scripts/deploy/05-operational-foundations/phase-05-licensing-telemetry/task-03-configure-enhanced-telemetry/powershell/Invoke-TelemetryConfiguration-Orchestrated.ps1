...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '05-operational-foundations/phase-05-licensing-telemetry/task-03-configure-enhanced-telemetry' `
    -ActionName 'Invoke-TelemetryConfiguration-Orchestrated' `
