...
invoke_bash_deployment "$0" '05-operational-foundations/phase-02-monitoring-observability/task-01-configure-log-analytics-workspace' 'az-configure-log-analytics' "$@"
