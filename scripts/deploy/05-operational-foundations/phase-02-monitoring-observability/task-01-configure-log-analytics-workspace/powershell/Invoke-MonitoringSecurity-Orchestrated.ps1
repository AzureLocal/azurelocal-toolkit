...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '05-operational-foundations/phase-02-monitoring-observability/task-01-configure-log-analytics-workspace' `
    -ActionName 'Invoke-MonitoringSecurity-Orchestrated' `
