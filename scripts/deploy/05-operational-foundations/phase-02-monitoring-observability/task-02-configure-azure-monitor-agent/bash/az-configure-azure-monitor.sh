...
invoke_bash_deployment "$0" '05-operational-foundations/phase-02-monitoring-observability/task-02-configure-azure-monitor-agent' 'az-configure-azure-monitor' "$@"
