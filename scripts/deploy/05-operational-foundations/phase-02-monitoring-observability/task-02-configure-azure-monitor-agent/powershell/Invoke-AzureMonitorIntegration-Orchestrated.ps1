...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '05-operational-foundations/phase-02-monitoring-observability/task-02-configure-azure-monitor-agent' `
    -ActionName 'Invoke-AzureMonitorIntegration-Orchestrated' `
