...
Invoke-DeploymentOrchestrated `
    ...
    -TaskPath '05-operational-foundations/phase-02-monitoring-observability/task-07-configure-datadog-integration' `
    -ActionName 'Invoke-DatadogConfiguration-Orchestrated' `
